...
int main(int argc, char ** argv) {
	...
	if (argc != 2) {
		...
		cerr << "Usage : ./main cles_alea/jeu_1_nb_cles_1000.txt" << endl;
		return 1;
	}
	...
	std::string filename;
	int tab[] = {1000, 5000, 10000, 20000, 50000, 80000, 120000, 200000/*, 400000, 600000, 800000, 1000000*/};
	...
	//Question 6
	cout << endl << "Mesures des temps sur l'oeuvre de Shakespeare..." << endl;
